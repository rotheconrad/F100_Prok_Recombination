...
def parse_ncbi_assembly_summary(infile, outpre, n, a):
...
def main():
    ...
    parser.add_argument(
        '-a', '--genome_assembly_level',
        help='Optional: One of Complete (default), Chromosome, Scaffold, or Contig',
        metavar='',
        type=str,
        required=False,
        default="Complete"
    ...
    a = args['genome_assembly_level']

    _ = parse_ncbi_assembly_summary(infile, outpre, n, a)
